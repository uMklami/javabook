...
public class PosTaggerClass {
	...
	public static void main(String[] args) {
		...
		try {
			...
			InputStream textStream = new FileInputStream("C:/apache-opennlp-1.9.2/models/en-token.bin");
			...
			InputStream inputStreamPOS = new FileInputStream("C:/apache-opennlp-1.9.2/models/en-pos-maxent.bin");
